...
<head runat="server">
	...
	<script src="<%= ConfigurationManager.AppSettings["ResourcesLocation"] %>/Scripts/ext/bootstrap.js"></script>
	<script src="<%= ConfigurationManager.AppSettings["ResourcesLocation"] %>/Scripts/ext/bootbox.min.js"></script>
	...
	<script src="http://www.worldwidetelescope.org/scripts/wwtsdk.aspx<%=DebugQs %>" type="text/javascript"></script>
	<script src="<%= ConfigurationManager.AppSettings["ResourcesLocation"] %>/Scripts/controls/WebControl.js?v=<%= ConfigurationManager.AppSettings["ResourcesVersion"] %>.x1"></script>
