...
namespace WWTMVC5.Services.Interfaces
{
    ...
    public interface IEntityService
    {
        ...
        IEnumerable<CommunityDetails> GetCommunities(EntityHighlightFilter entityHighlightFilter, PageDetails pageDetails);
        ...
        /// <returns>List of all communities</returns>
        IEnumerable<CommunityDetails> GetAllCommunities(long userID, int? categoryID);
        ...
        /// <returns>List of all contents</returns>
        IEnumerable<ContentDetails> GetAllContents(long userID, int? categoryID);
        ...
        /// <param name="entityHighlightFilter">Filters needed while retrieving collection of entities</param>
        /// <returns>List of all communities</returns>
        IEnumerable<CommunityDetails> GetCommunities(EntityHighlightFilter entityHighlightFilter);
        ...
        /// <param name="entityHighlightFilter">Filters needed while retrieving collection of entities</param>
        /// <returns>List of all contents</returns>
        IEnumerable<ContentDetails> GetContents(EntityHighlightFilter entityHighlightFilter);
        ...
        IEnumerable<EntityDetails> GetTopCategories();
